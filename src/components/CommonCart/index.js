...
export default function CommmonCart({ cartItems = [],handleDeleteCartItem,componentLevelLoader }) {
  return (
    <section className="h-screen bg-gray-100">
      <div className="mx-auto sm:px-6 lg:px-8">
        <div className="mx-auto mt-8 max-w-screen-xl px-4 sm:px-6 lg:px-6">
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col justify-between">
                          <div className="sm:col-gap-5 sm:grid sm:grid-cols-2">
                            ...
                            <div className="mt-4 flex gap-3 justify-between items-end sm:mt-0 sm:items-start sm:justify-end">
                              <p className="shrink-0 w-20 text-base sm:order-1 sm:ml-8 sm:text-right font-semibold">
                                {cartItem &&
                                  cartItem.productID &&
                              ...
                              text={'Removing'}
                              color={'#000000'}
                              loading={componentLevelLoader && componentLevelLoader.loading}/>:'Remove'}
